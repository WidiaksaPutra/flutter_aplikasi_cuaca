...
class ContinerBottomLandscape extends StatelessWidget with sizeDevice {
  final String param1, icon, param2, light;
  const ContinerBottomLandscape({ Key? key, required this.param1, required this.icon, required this.param2, required this.light }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    ? Container(
        ...
        width: (getWidthVisiblePortrait() == false) ? getWidth(80).w : getWidth(100).w,
