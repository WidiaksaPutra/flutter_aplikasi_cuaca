        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Padding(padding: EdgeInsets.symmetric(vertical: 3.h), child: Text("Updated ${widget.jamNow}min ago", style: TextStyle(fontSize: 12.sp, color: whiteColor, fontWeight: FontWeight.bold, fontFamily: "OpenSauceSans") ,textAlign: TextAlign.center)),
            ),
