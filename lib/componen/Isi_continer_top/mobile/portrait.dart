...
class IsiContinerTopPortrait extends StatelessWidget with sizeDevice {
  final String icon, param1, param2;
  const IsiContinerTopPortrait({ Key? key,  required this.icon, required this.param1, required this.param2 }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: Column(
        ...
        children: [
          (getWidthVisiblePortrait() == false) ? const Text("") : Image.network('http://openweathermap.org/img/wn/$icon.png'),
