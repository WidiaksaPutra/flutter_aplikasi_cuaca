...
class IsiCardInformasiMinLanscape extends StatelessWidget with sizeDevice{
   final String icon, description, day, windSpeed, rain, humidity, feelsLike;
  const IsiCardInformasiMinLanscape({ Key? key, required this.icon, required this.description, 
  ...
  Widget build(BuildContext context) {
    return CardInformasiCuaca(
      child: SizedBox(
        width:(sizeDevice.sizeWidth - getWidth(400)).w,
